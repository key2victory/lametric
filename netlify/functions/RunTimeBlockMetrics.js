...
function RunMetrics() {
return JSON.stringify(DisplayMetrics);
};
...
console.log(`${CurrentMetrics.blocks_remaining} blocks`);
console.log(`${FormattedTime} hr`);
console.log(FormattedCurrentPercent);
console.log(JSON.stringify(DisplayMetrics));
